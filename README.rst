...
Note: The `Go language <https://golang.org/>`_ 1.8 and 1.9 will no longer be supported from Nov 5th, 2018 since `Go lint <http://github.com/golang/lint>`_ already dropped their support for 1.8, and we decided to follow the `Go Release Policy <https://golang.org/doc/devel/release.html#policy>`_.
