	...
	testCases := []paramList{
		{
			testParams: []string{"user", "password", "host", "account", "warehouse", "database",
				...
				"workload_identity_provider", "workload_identity_entra_resource", "workload_identity_host", "workloadIdentityHost",
				"proxyHost", "noProxy", "proxyUser", "proxyPassword", "proxyProtocol"},
			values: []any{"value"},
		},
		{
