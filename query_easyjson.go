	...
	for !in.IsDelim('}') {
		...
		case "asyncResult":
			if in.IsNull() {
				...
				easyjson90b16446DecodeGosnowflake5(in, out.AsyncResult)
			}
		case "asyncRows":
			if in.IsNull() {
				in.Skip()
				...
				easyjson90b16446DecodeGosnowflake6(in, out.AsyncRows)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson90b16446EncodeGosnowflake1(out *jwriter.Writer, in execResponseData) {
	...
	if in.AsyncResult != nil {
		...
		easyjson90b16446EncodeGosnowflake5(out, *in.AsyncResult)
	}
	if in.AsyncRows != nil {
		...
		easyjson90b16446EncodeGosnowflake6(out, *in.AsyncRows)
	}
	out.RawByte('}')
}
func easyjson90b16446DecodeGosnowflake6(in *jlexer.Lexer, out *snowflakeRows) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "rowType":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjson90b16446DecodeGosnowflake3(in, &v18)
...
func easyjson90b16446EncodeGosnowflake6(out *jwriter.Writer, in snowflakeRows) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.RowType == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v19, v20 := range in.RowType {
				...
				easyjson90b16446EncodeGosnowflake3(out, v20)
			}
			out.RawByte(']')
		}
	}
...
func easyjson90b16446DecodeGosnowflake5(in *jlexer.Lexer, out *snowflakeResult) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson90b16446EncodeGosnowflake5(out *jwriter.Writer, in snowflakeResult) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
