...
java -jar "$SCRIPT_DIR/wiremock-standalone-3.11.0.jar" --port ${WIREMOCK_PORT:=14355} --https-port ${WIREMOCK_HTTPS_PORT:=13567} --https-keystore "$pfxFile" --keystore-type PKCS12 --keystore-password password --verbose
