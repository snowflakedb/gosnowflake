...
curl -fsSL "https://artifactory.ci1.us-west-2.aws-dev.app.snowflake.com/artifactory/development-github-virtual/snowflake-eng/revocation-validation/archive/refs/heads/${REVOCATION_BRANCH}.tar.gz" | tar -xz --strip-components=1 -C "$REVOCATION_DIR"
