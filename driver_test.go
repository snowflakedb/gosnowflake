...
func init() {
	...
	username = env("SNOWFLAKE_TEST_USER", "SEN")
	pass = env("SNOWFLAKE_TEST_PASSWORD", "Sunshine4Snowflake")
	account = env("SNOWFLAKE_TEST_ACCOUNT", "simbapartner")
	dbname = env("SNOWFLAKE_TEST_DATABASE", "JOHNTESTDB")
	schemaname = env("SNOWFLAKE_TEST_SCHEMA", "testschema")
	rolename = env("SNOWFLAKE_TEST_ROLE", "sysadmin")
	warehouse = env("SNOWFLAKE_TEST_WAREHOUSE", "SIMBA_WH_TEST")
