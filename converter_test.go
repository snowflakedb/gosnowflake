...
func TestSnowflakeTypeToGo(t *testing.T) {
	testcases := []struct {
		...
		{in: decfloatType, scale: 38, out: reflect.TypeOf(float64(0)), ctx: WithDecfloatEnabled(context.Background())},
		{in: decfloatType, scale: 38, out: reflect.TypeOf(&big.Float{}), ctx: WithHigherPrecision(WithDecfloatEnabled(context.Background()))},
