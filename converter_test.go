...
func TestGoTypeToSnowflake(t *testing.T) {
	testcases := []tcGoTypeToSnowflake{
		...
		{in: Array([]interface{}{int64(123)}), tmode: nil, out: sliceType},
		{in: Array([]interface{}{float64(234.56)}), tmode: nil, out: sliceType},
		{in: Array([]interface{}{true}), tmode: nil, out: sliceType},
		{in: Array([]interface{}{"teststring"}), tmode: nil, out: sliceType},
		{in: Array([]interface{}{[]byte{1, 2, 3}}), tmode: nil, out: sliceType},
