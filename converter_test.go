...
func TestGoTypeToSnowflake(t *testing.T) {
	testcases := []tcGoTypeToSnowflake{
		...
		{in: time.Now(), tmode: nullType, out: timestampNtzType},
		...
		{in: DataTypeFixed, tmode: nullType, out: changeType},
		{in: DataTypeReal, tmode: nullType, out: changeType},
		{in: DataTypeText, tmode: nullType, out: changeType},
		{in: DataTypeDate, tmode: nullType, out: changeType},
		{in: DataTypeVariant, tmode: nullType, out: changeType},
		...
		{in: DataTypeObject, tmode: nullType, out: changeType},
		{in: DataTypeArray, tmode: nullType, out: changeType},
		{in: DataTypeBinary, tmode: nullType, out: changeType},
		{in: DataTypeTime, tmode: nullType, out: changeType},
		{in: DataTypeBoolean, tmode: nullType, out: changeType},
		{in: DataTypeNull, tmode: nullType, out: changeType},
		// negative
