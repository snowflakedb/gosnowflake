...
func TestGoTypeToSnowflake(t *testing.T) {
	testcases := []tcGoTypeToSnowflake{
		...
		{in: mustArray([]int{1}), tmode: nullType, out: sliceType},
		{in: mustArray(&[]int{1}), tmode: nullType, out: sliceType},
		{in: mustArray([]int32{1}), tmode: nullType, out: sliceType},
		{in: mustArray(&[]int32{1}), tmode: nullType, out: sliceType},
		{in: mustArray([]int64{1}), tmode: nullType, out: sliceType},
		{in: mustArray(&[]int64{1}), tmode: nullType, out: sliceType},
		{in: mustArray([]float64{1.1}), tmode: nullType, out: sliceType},
		{in: mustArray(&[]float64{1.1}), tmode: nullType, out: sliceType},
		{in: mustArray([]float32{1.1}), tmode: nullType, out: sliceType},
		{in: mustArray(&[]float32{1.1}), tmode: nullType, out: sliceType},
		{in: mustArray([]bool{true}), tmode: nullType, out: sliceType},
		{in: mustArray([]string{"test string"}), tmode: nullType, out: sliceType},
		{in: mustArray([][]byte{}), tmode: nullType, out: sliceType},
		{in: mustArray([]time.Time{time.Now()}, TimestampNTZType), tmode: timestampNtzType, out: sliceType},
		{in: mustArray([]time.Time{time.Now()}, TimestampLTZType), tmode: timestampLtzType, out: sliceType},
		{in: mustArray([]time.Time{time.Now()}, TimestampTZType), tmode: timestampTzType, out: sliceType},
		{in: mustArray([]time.Time{time.Now()}, DateType), tmode: dateType, out: sliceType},
		{in: mustArray([]time.Time{time.Now()}, TimeType), tmode: timeType, out: sliceType},
		...
		{in: mustArray([]interface{}{int64(123)}), tmode: nullType, out: sliceType},
		{in: mustArray([]interface{}{float64(234.56)}), tmode: nullType, out: sliceType},
		{in: mustArray([]interface{}{true}), tmode: nullType, out: sliceType},
		{in: mustArray([]interface{}{"teststring"}), tmode: nullType, out: sliceType},
		{in: mustArray([]interface{}{[]byte{1, 2, 3}}), tmode: nullType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}), tmode: timestampNtzType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}), tmode: timestampTzType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}), tmode: timestampLtzType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}), tmode: dateType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}), tmode: timeType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}, TimestampNTZType), tmode: timestampLtzType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}, TimestampLTZType), tmode: dateType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}, TimestampTZType), tmode: timeType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}, DateType), tmode: timestampNtzType, out: sliceType},
		{in: mustArray([]interface{}{time.Now()}, TimeType), tmode: timestampTzType, out: sliceType},
