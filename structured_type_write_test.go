	...
	testcases := []struct {
		...
		},
		{
			...
			values: []any{DataTypeDate, map[string]sql.NullTime{
				"a": {time.Date(2024, time.June, 25, 0, 0, 0, 0, time.UTC), true},
				"b": {time.Date(0, 0, 0, 0, 0, 0, 0, time.UTC), false},
			}},
		...
		},
		{
			...
			values: []any{DataTypeTime, map[string]sql.NullTime{
				"a": {time.Date(1, time.January, 1, 11, 22, 33, 0, time.UTC), true},
				"b": {time.Date(0, 0, 0, 0, 0, 0, 0, time.UTC), false},
			}},
			expected: map[string]sql.NullTime{
				"a": {time.Date(1, time.January, 1, 11, 22, 33, 0, time.UTC), true},
		...
		},
		{
			...
			values: []any{DataTypeTimestampNtz, map[string]sql.NullTime{
				"a": {time.Date(2024, time.June, 25, 11, 22, 33, 0, time.UTC), true},
				"b": {time.Date(0, 0, 0, 0, 0, 0, 0, time.UTC), false},
			}},
			expected: map[string]sql.NullTime{
				"a": {time.Date(2024, time.June, 25, 11, 22, 33, 0, time.UTC), true},
		...
		},
		{
			...
			values: []any{DataTypeTimestampTz, map[string]sql.NullTime{
				"a": {time.Date(2024, time.June, 25, 11, 22, 33, 0, warsawTz), true},
				"b": {time.Date(0, 0, 0, 0, 0, 0, 0, time.UTC), false},
			}},
			expected: map[string]sql.NullTime{
				"a": {time.Date(2024, time.June, 25, 11, 22, 33, 0, warsawTz), true},
